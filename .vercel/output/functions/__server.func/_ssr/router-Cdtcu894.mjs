...
//#region node_modules/.nitro/vite/services/ssr/assets/router-Cdtcu894.js
var router_Cdtcu894_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-BusvpgBe.css";
...
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Gomarch — private recovery vault for the Gomark system."
			},
			{
				name: "theme-color",
				content: "#07080a"
...
var $$splitComponentImporter = () => import("./routes-BeVzaPDS.mjs");
...
//#endregion
export { getRouter, router_Cdtcu894_exports as t };
